                        ...
                        <div className="header__body d-flex justify-content-between">
                            <div className="header__left">
                                <div className="logo">
                                    ...
                                    <NavLink to='/home-v2' className="dark">
                                        <img
                                            src={logodark}
                                            alt="Rockie"
                                        />
                            ...
                            <Dropdown>
                                ...
                                <div className="wallet">
                                    <Link to="/wallet"> Level System </Link>
                                </div>
                                ...
                                <Dropdown className='user'>
                                    ...
                                    <Dropdown.Menu>
                                        ...
                                        <Dropdown.Item href="#">
                                            <Link className="dropdown-item" to="/contact"><i className="bx bx-envelope font-size-16 align-middle me-1"></i>
                                                <span>Contact</span></Link>
                                        </Dropdown.Item>
                                        <Dropdown.Item href="#">
                                            <Link className="dropdown-item" to="/faq"><i className="bx bx-help-circle font-size-16 align-middle me-1"></i>
                                                <span>FAQ</span></Link>
                                        </Dropdown.Item>
                                        <Dropdown.Item href="#">
